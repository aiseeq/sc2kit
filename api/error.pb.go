...
func (ActionResult) Descriptor() protoreflect.EnumDescriptor {
	return file_s2clientprotocol_error_proto_enumTypes[0].Descriptor()
}

func (ActionResult) Type() protoreflect.EnumType {
	return &file_s2clientprotocol_error_proto_enumTypes[0]
}
...
func (ActionResult) EnumDescriptor() ([]byte, []int) {
	return file_s2clientprotocol_error_proto_rawDescGZIP(), []int{0}
}

var File_s2clientprotocol_error_proto protoreflect.FileDescriptor

const file_s2clientprotocol_error_proto_rawDesc = "" +
	"\n" +
...
var (
	file_s2clientprotocol_error_proto_rawDescOnce sync.Once
	file_s2clientprotocol_error_proto_rawDescData []byte
)

func file_s2clientprotocol_error_proto_rawDescGZIP() []byte {
	file_s2clientprotocol_error_proto_rawDescOnce.Do(func() {
		file_s2clientprotocol_error_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_s2clientprotocol_error_proto_rawDesc), len(file_s2clientprotocol_error_proto_rawDesc)))
	})
	return file_s2clientprotocol_error_proto_rawDescData
}

var file_s2clientprotocol_error_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_s2clientprotocol_error_proto_goTypes = []any{
	(ActionResult)(0), // 0: SC2APIProtocol.ActionResult
}
var file_s2clientprotocol_error_proto_depIdxs = []int32{
...
func init() { file_s2clientprotocol_error_proto_init() }
func file_s2clientprotocol_error_proto_init() {
	if File_s2clientprotocol_error_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_s2clientprotocol_error_proto_rawDesc), len(file_s2clientprotocol_error_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_s2clientprotocol_error_proto_goTypes,
		DependencyIndexes: file_s2clientprotocol_error_proto_depIdxs,
		EnumInfos:         file_s2clientprotocol_error_proto_enumTypes,
	}.Build()
	File_s2clientprotocol_error_proto = out.File
	file_s2clientprotocol_error_proto_goTypes = nil
	file_s2clientprotocol_error_proto_depIdxs = nil
}
